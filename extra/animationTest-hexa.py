...
if __name__ == "__main__":
    ...
    disc1 = ax.scatter([], [], [], color="blue", s=20)
    disc2 = ax.scatter([], [], [], color="red", s=20)
    disc3 = ax.scatter([], [], [], color="red", s=20)
    disc4 = ax.scatter([], [], [], color="blue", s=20)
    disc5 = ax.scatter([], [], [], color="blue", s=20)
    disc6 = ax.scatter([], [], [], color="blue", s=20)
